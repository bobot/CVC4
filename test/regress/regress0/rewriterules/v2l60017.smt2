...
(declare-fun x5 () tree)
(declare-fun x6 () tree)
(assert (not (not (and (and (and (and (and (not (= x6 (leaf (pred (data x6))))) (= x1 zero)) (= x6 (node (children (leaf x2))))) (not (is_zero (data x6)))) (is_null null)) (not (= (succ (data x5)) (succ (data (car null)))))))))
(check-sat)
(exit)
