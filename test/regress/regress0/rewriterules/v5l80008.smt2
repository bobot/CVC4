...
(assert (not (not (and (and (and (and (and (and (and (not (= (pred x5) x5)) (not (is_leaf (node x6)))) (is_leaf x11)) (= x4 (data x15))) (= (children x15) x10)) (= x6 null)) (not (= (children (leaf (pred x5))) x6))) (not (= x10 (children (leaf x1))))))))
(check-sat)
(exit)
