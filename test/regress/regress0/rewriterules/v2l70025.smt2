...
(declare-fun x5 () tree)
(declare-fun x6 () tree)
(assert (not (not (and (and (and (and (and (and (not (= (succ (succ x2)) x1)) (= x1 x2)) (not (= (cdr (children (leaf x1))) null))) (= null x4)) (not (= (children (node null)) (children (node (cons x5 (cons (leaf (data (node null))) x3))))))) (is_cons (children (car x3)))) (= x3 (children x6))))))
(check-sat)
(exit)
