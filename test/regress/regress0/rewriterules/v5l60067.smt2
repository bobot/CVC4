...
(assert (not (not (and (and (and (and (and (not (is_node x13)) (= x3 (data x15))) (not (= x10 null))) (not (= (cdr (cons (car x8) (children (leaf zero)))) null))) (not (= (cons x11 (cons x13 x10)) x8))) (= null (children (car x10)))))))
(check-sat)
(exit)
