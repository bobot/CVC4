...
(assert (not (not (and (and (and (and (and (and (and (and (not (= (leaf (data x11)) x12)) (not (is_succ zero))) (= x11 x15)) (= (children (leaf x3)) (cons (car (cdr null)) x6))) (= x13 (leaf (pred x4)))) (= x1 x2)) (not (is_cons null))) (is_null x6)) (= null x6)))))
(check-sat)
(exit)
